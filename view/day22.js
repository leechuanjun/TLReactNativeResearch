              ...
              <Animated.View style={[styles.btnContent,{transform:[{scale:this.state.scale}]}]}>
                {this.state.on?
                    <View style={[styles.btnContent,{backgroundColor:"#ff3b3e",top:8,transform:[{scale:0.05}]}]}>
                      <Icon name="ios-microphone" size={25} color="#fff"/>
                    </View>:
                  <Icon name="ios-microphone" size={25} color="#4285f4"/>}
              </Animated.View>
            </TouchableWithoutFeedback>
          </View>
        </View>
        {this.state.scaleOn?
          <View style={styles.scaleContainer}>
            ...
            <TouchableWithoutFeedback style={styles.close} onPress={() => this._offMic()}>
              <Icon name="ios-close" style={styles.closeIcon} color="#969696" size={25}/>
            </TouchableWithoutFeedback>
          </View>:
          <View></View>}
      </View>
